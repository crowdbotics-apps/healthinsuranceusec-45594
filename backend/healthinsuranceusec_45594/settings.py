"""
Django settings for healthinsuranceusec_45594 project.
...
ROOT_URLCONF = 'healthinsuranceusec_45594.urls'
...
WSGI_APPLICATION = 'healthinsuranceusec_45594.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthinsuranceusec_45594 API",
    "DESCRIPTION": "API documentation for healthinsuranceusec_45594 App",
    "VERSION": "v1",
}
